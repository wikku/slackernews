defmodule SlackernewsWeb.PostLiveTest do
  use SlackernewsWeb.ConnCase

  import Phoenix.LiveViewTest
  import Slackernews.PostsFixtures

  @create_attrs %{title: "some title", body: "some body", url: "some url"}
  @update_attrs %{title: "some updated title", body: "some updated body", url: "some updated url"}
  @invalid_attrs %{title: nil, body: nil, url: nil}
